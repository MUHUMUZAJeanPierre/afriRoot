      ...
      <div className=" container pt-2">
          <div className=" md:flex md:justify-evenly border-b md:gap-4 border-solid border-white pb-9 pl-4 sm:pl-8">
              <div className="">
                  ...
                  <a href="">
                      <div className="w-[15rem] h-[10rem]  mt-4 ">
                        <img src="../../../src/assets/bgafri1.jpg" alt="" className="w-[10rem] h-[10rem] bg-blue-600 rounded-full "/>
              ...
              <div className="mb-4 sm:mb-12 lg:mb-12 ">
                  <span>
                          <ul className=''>
                              <li className=''>
                                  <h1 className="headingTwo">Our company</h1>
                              </li>
                              <li className=''>
                              ...
                              <li className=''>
                                  <a href="" className='anchorTag'>AFRI Class</a>
                              </li>
                          </ul>
                  </span>
              </div>
          ...
          <div className="md:flex justify-between pt-8 pb-8 pl-4 sm:pl-8">
              <div className="pl-9">
                  <p className="text-white text-xl font-sans font-bold">Copyright © 2022 AFRIFOOT</p>
              </div>
              <div className="pr-20">
                  <p className="text-white text-xl font-sans">Designed By AFRI ROOT</p>
              </div>
          </div>
