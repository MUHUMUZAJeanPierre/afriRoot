    ...
    return (
      ...
      <div className=" container">
              ...
              <div className="">
                  ...
                  <a href="">
                      <div className="w-[15rem]  ">
                        <img src="../../../src/assets/bgafri1-removebg-preview.png" alt="" className=" w-[10rem] h-[10rem] rounded-full "/>
          ...
          <div className="md:flex justify-between py-2 pl-4 sm:pl-8">
              <div className="pl-9">
                  <p className="text-white text-sm font-medium">Copyright © 2022 AFRIFOOT</p>
              </div>
              <div className="pr-20">
                  <p className="text-white text-sm font-normal">Designed By AFRI ROOT</p>
              </div>
          </div>
