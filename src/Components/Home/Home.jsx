...
{/* OUR HISTORY AND WHAT WE ARE  */}
      ...
      <div className="bg-image-1 lg:h-screen " >
        <div  className="lg:flex flex-row    pt-[5rem]  md:px-[4rem] md:pr-[8rem] relative ">
        <div style={{ background: "#F8FAFA" }} className=" rounded-lg p-10  ml-[3rem]">
        <h2  style={{color: '#CB8342'}} className="font-serif font-semibold text-lg  flex-row items-center ">
          <span className="text-3xl px-2">
            <HiOutlineLightBulb  className='mx-auto text-6xl mt-[-3rem]' />
          </span>
          Applied Cultural Studies
        </h2>
        <p className="max-w-md flex justify-center m-4 text-[#3A3A3A]"v>
      ...
      <div style={{ background: "#F8FAFA" }} className="rounded-lg p-10  ml-[3rem]">
        ...
        <p className="max-w-md flex justify-center m-4 text-[#3A3A3A]">
        Programs that apply cultural studies to real-world 
        scenarios, such as business practices, diplomacy, or intercultural communication. 
